...
<head>
    ...
    <title><?php echo $settings_result['site_title'] ?> : My Reserved Accommodations</title>
...
<?php include('ajax/get_my_reserved_accommodations.php'); ?>

<body class="bg-light" style="display: flex; flex-direction: column; min-height: 100vh; ">
    <main style="flex:1">
        <div class="container my-5">
            <h2 class="fw-bold h-font text-center">My Reserved Accommodations</h2>

            <?php
            $pendingAccommodations = getMyreservedAccommodations();
            ?>
