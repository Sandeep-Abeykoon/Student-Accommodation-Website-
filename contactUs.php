        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                <div class="bg-white rounded shadow p-4">
                    ...
                    <h5>Address</h5>
                    <a href="https://maps.app.goo.gl/BydHW6vmxPG7zmFZA" target="_blank" class="d-inline-block text-decoration-none text-dark mb-2"><i class="bi bi-geo-alt-fill me-1"></i>Pitipana - Thalagala Rd, Homagama</a>
                    <h5>Call Us</h5>
          ...
          <a href="tel:+94115445000" class="d-inline-block text-decoration-none text-dark"><i class="bi bi-telephone-fill"></i> +94 115445000</a>
            ...
            <div class="col-lg-6 col-md-6 px-4">
                <div class="bg-white rounded shadow p-4">
                    ...
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eius autem velit nesciunt! A ipsa quasi voluptate soluta odio explicabo officia?</p>
                </div>
            </div>
        </div>
    </div>
